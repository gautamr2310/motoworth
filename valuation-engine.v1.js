(function(global){
  ...
  function evaluate(input, rules){
    ...
    let baseline=referencePrice*residual(age,rules);
    ...
    baseline=Math.max(referencePrice*num(rules.residual_floor,0.18), baseline-reserve);
    ...
    return {
      valuationYear, registrationYear, age, referencePrice,
  ...
  global.MotoWorthEngine={evaluate, residual, normalizeComp, median};
})(window);
